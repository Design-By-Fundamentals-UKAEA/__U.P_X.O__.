...
# ====================================================================
# Temperature specifications along the z-axis
T0 = 0.0001
T40 = 0.001
T45 = 2.0
T50 = 10.0
...
temp_spec = np.array([(0, 0.0001),
                      ...
                      (80, 0.001),
                      (100, 0.0001)])
#temp_spec = np.array([(000, 0.0001), (40, 0.0001), (45, 0.0001),
#                      (50, 0.0001), (60, 0.0001), (65, 0.0001),
#                      (80, 0.0001), (100, 0.0001)])
# Extracting the z positions and corresponding temperature values
z_positions, temperatures = temp_spec[:, 0], temp_spec[:, 1]
# Interpolate the temperatures along the z-axis using a piecewise linear function
z_full_range = np.arange(0, 101)  # z starting at 0, ending at 100, in steps of 1
temperature_gradient = np.interp(z_full_range, z_positions, temperatures)
'''
plt.figure()
...
grid.cell_data["scalars"] = scalar_data  # Use 'cell_data' instead of 'cell_arrays'
